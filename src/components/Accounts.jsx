          ...
          return (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-black dark:text-gray-300 text-base 2xl:text-lg font-medium">
                    {accountName}
                  </p>
                  <span className="text-sm text-gray-600 dark:text-gray-400 2xl:text-base">
              ...
              <div className="text-right">
                ...
                <span className="text-xs 2xl:text-sm text-gray-500 dark:text-violet-400">
                  Account Balance
                </span>
              </div>
            </div>
