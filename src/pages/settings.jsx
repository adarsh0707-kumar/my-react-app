...
const Settings = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      <div className="w-full max-w-4xl px-4 my-6 shadow-lg bg-gray-50 dark:bg-black/50 md:px-10 md:py-10">
        ...
        <div className='py-10'>
          ...
          <div className="flex items-center gap-4 my-8">
            <div className="flex items-center justify-center w-12 h-12 text-white text-2xl font-bold rounded-full cursor-pointer bg-violet-600">
